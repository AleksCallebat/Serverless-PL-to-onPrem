...
#   managed_disk_cmk_key_vault_key_id     = var.is_kms_enabled ? azurerm_key_vault_key.databricks.id : null
#   managed_services_cmk_key_vault_key_id = var.is_kms_enabled ? azurerm_key_vault_key.databricks.id : null
